...
const Pant = () => {
    const mensPants = data?.products.filter((product) => product?.category?.toLowerCase() === 'kids');
    // console.log(mensTshirt);
    const mensPants1 = mensPants?.filter((product) => product?.subcategory?.toLowerCase()==='shirt');
